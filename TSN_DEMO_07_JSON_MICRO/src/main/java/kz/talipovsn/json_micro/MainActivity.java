...
//            JSONArray array = null;
            try {
                ...
                for (int i = 0; i < array.length(); i ++){
                    ...
                    String login = array1.getString("login");
                    String id = array1.getString("id");
                    String html_url = array1.getString("html_url");
                    String type = array1.getString("type");
                    textView.append("Кого фолловит proffix4: " + "\n");
                    textView.append("Логин: " + login + "\n");
                    textView.append("Тип пользователя: " + type + "\n");
                    textView.append("Ссылка: " + html_url + "\n");
